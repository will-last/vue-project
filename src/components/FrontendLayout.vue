  ...
  <div class="frontend-layout">
    <div class="navbar-container">
        <div class="brand-section">
            <el-image style="width: 50px;" :src="iconUrl" class="brand-logo" alt="品牌logo"></el-image>
        ...
        <div class="nav-section">
            ...
            <el-button class="logout-btn" size="medium" v-if="isLoggedIn" @click="handleLogout">退出登录</el-button>
            <template v-else>
