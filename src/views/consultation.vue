    ...
    <div class="sidebar">
      <div class="ai-assistant-info">
        <div class="breathing-circle">
          <el-image style="width: 25px" :src="iconUrl1" alt="AI助手" />
        </div>
            ...
            <div class="session-info">
              <div class="session-title">
                ...
                <div class="session-stats">
                  <span
                    ><el-icon><ChatRound /></el-icon>{{ session.messageCount || 0 }}</span
                  >
                  <span
                    ><el-icon><Clock /></el-icon>{{ session.durationMinutes || 0 }}分钟</span
                  >
                </div>
              </div>
      ...
      <div class="chat-header">
        <div class="header-left">
          <div class="chat-avatar">
            <el-image style="width: 30px" :src="iconUrl2" alt="聊天头像" />
          </div>
          <div class="chat-info">
            <h2>宁渡AI助手</h2>
            <p>您的贴心AI心理健康助手</p>
      ...
      <div class="chat-messages">
        <div class="message-item ai-message" v-if="messages.length === 0">
          <div class="message-avatar">
            <el-image style="width: 18px" :src="iconUrl1" alt="AI助手" />
          </div>
        ...
        >
          <div class="message-avatar">
            <el-image v-if="msg.senderType === 1" style="width: 18px" :src="iconUrl3" />
            <el-image v-if="msg.senderType === 2" style="width: 18px" :src="iconUrl1" />
          </div>
          <div class="message-content">
            <div class="message-bubble">
              <div
...
const iconUrl1 = new URL('@/assets/images/robot.png', import.meta.url).href
