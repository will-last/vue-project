        ...
        <div class="content">
            <div class="text">
                ...
                <div class="hero-actions">
                    ...
                    <el-button size="large" @click="()=>router.push('/emotion-diary')"
                        style="border-color: #fff" color="transparent">记录心情，释放情感</el-button>
                </div>
            </div>
            <div class="robot">
                <el-image class="robot-image" style="width: 150px;" :src="iconUrl" alt="机器人"></el-image>
            </div>
        </div>
    </div>
</template>
