                ...
                <el-card v-if="aiData.systemOverview">
                    <div class="card-content">
                        <div class="avatar users">
                            <el-image style="width: 40px;" :src="iconUrl1" />
                        </div>
                        <div class="info">
                ...
                <el-card v-if="aiData.systemOverview">
                    <div class="card-content">
                        <div class="avatar like">
                            <el-image style="width: 40px;" :src="iconUrl2" />
                        </div>
                        <div class="info">
                ...
                <el-card v-if="aiData.systemOverview">
                    <div class="card-content">
                        <div class="avatar comments">
                            <el-image style="width: 40px;" :src="iconUrl3" />
                        </div>
                        <div class="info">
                ...
                <el-card v-if="aiData.systemOverview">
                    <div class="card-content">
                        <div class="avatar smile">
                            <el-image style="width: 40px;" :src="iconUrl4" />
                        </div>
                        <div class="info">
        ...
        <el-row style="margin-top: 20px;" :gutter="20">
            ...
            <el-col :span="12">
                <el-card style="width: 100%;">
                    ...
                    <div class="chart-content">
                        <div v-if="consultationStats" class="consultation-stats">
                            <div class="stat-item">
